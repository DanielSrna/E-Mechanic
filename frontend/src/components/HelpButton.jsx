  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="w-full h-10 rounded-lg flex items-center justify-center text-sm font-medium transition bg-white/10 hover:bg-white/20 text-white/70 hover:text-white btn-repeat-tour"
        title="Ayuda"
      >
